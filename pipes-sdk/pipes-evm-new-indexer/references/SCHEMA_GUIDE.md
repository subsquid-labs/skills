...
tx_index          UInt16,              -- Transaction index
...
ORDER BY (pool_address, block_number, tx_index, log_index)

-- Token-specific queries (e.g., ERC20 transfers by token)
ORDER BY (token_address, block_number, tx_index, log_index)
...
3. Last columns: uniqueness (tx_index, log_index)
